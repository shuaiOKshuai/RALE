...
class email_DataGenerator:
	...
	def make_data_tensor(self, options, node_pairs_subpaths_file):
		...
		neis_1_order = tf.concat([tf.reshape(subpaths_s_nodes_array_batch, [tf.shape(subpaths_s_nodes_array_batch)[0], tf.shape(subpaths_s_nodes_array_batch)[1], 1]), neis_1_order[:, :, 1:]], axis=-1) 
		neis_2_order = tf.nn.embedding_lookup(self.neisArray, neis_1_order) 
		indeces_2 = tf.random_uniform(shape=[self.max_degree_2_order,], maxval=self.max_degree, dtype=tf.int32) 
		neis_2_order = tf.gather(neis_2_order, indeces_2, axis=-1) 
		subpaths_s_array_batch_neis_2_order = tf.concat([tf.reshape(neis_1_order, [tf.shape(neis_1_order)[0], tf.shape(neis_1_order)[1], tf.shape(neis_1_order)[2], 1]), neis_2_order[:, :, :, 1:]], axis=-1) 
		...
		indeces_2 = tf.random_uniform(shape=[self.max_degree_2_order,], maxval=self.max_degree, dtype=tf.int32) 
		neis_s_2_order = tf.gather(nodes_s_2_order, indeces_2, axis=-1) 
		nodes_s_2_order = tf.concat([tf.reshape(nodes_s_1_order, [tf.shape(nodes_s_1_order)[0], tf.shape(nodes_s_1_order)[1], tf.shape(nodes_s_1_order)[2], 1]), neis_s_2_order[:, :, :, 1:]], axis=-1) 
		...
		neis_1_order = tf.concat([tf.reshape(subpaths_q_nodes_array_batch, [tf.shape(subpaths_q_nodes_array_batch)[0], tf.shape(subpaths_q_nodes_array_batch)[1], 1]), neis_1_order[:, :, 1:]], axis=-1) 
		neis_2_order = tf.nn.embedding_lookup(self.neisArray, neis_1_order) 
		neis_2_order = tf.gather(neis_2_order, indeces_2, axis=-1) 
		subpaths_q_array_batch_neis_2_order = tf.concat([tf.reshape(neis_1_order, [tf.shape(neis_1_order)[0], tf.shape(neis_1_order)[1], tf.shape(neis_1_order)[2], 1]), neis_2_order[:, :, :, 1:]], axis=-1) 
		...
		neis_1_order = tf.concat([tf.reshape(hub_subpaths_s_nodes_array_batch, [tf.shape(hub_subpaths_s_nodes_array_batch)[0], tf.shape(hub_subpaths_s_nodes_array_batch)[1], 1]), neis_1_order[:, :, 1:]], axis=-1) 
		neis_2_order = tf.nn.embedding_lookup(self.neisArray, neis_1_order) 
		neis_2_order = tf.gather(neis_2_order, indeces_2, axis=-1) 
		hub_subpaths_s_nodes_array_batch_neis_2_order = tf.concat([tf.reshape(neis_1_order, [tf.shape(neis_1_order)[0], tf.shape(neis_1_order)[1], tf.shape(neis_1_order)[2], 1]), neis_2_order[:, :, :, 1:]], axis=-1) 
		...
		neis_1_order = tf.concat([tf.reshape(hub_subpaths_q_nodes_array_batch, [tf.shape(hub_subpaths_q_nodes_array_batch)[0], tf.shape(hub_subpaths_q_nodes_array_batch)[1], 1]), neis_1_order[:, :, 1:]], axis=-1) 
		neis_2_order = tf.nn.embedding_lookup(self.neisArray, neis_1_order) 
		neis_2_order = tf.gather(neis_2_order, indeces_2, axis=-1) 
		hub_subpaths_q_nodes_array_batch_neis_2_order = tf.concat([tf.reshape(neis_1_order, [tf.shape(neis_1_order)[0], tf.shape(neis_1_order)[1], tf.shape(neis_1_order)[2], 1]), neis_2_order[:, :, :, 1:]], axis=-1) 
		
		return subpaths_s_array_batch, subpaths_lens_s_array_batch, node_pairs_s_valid_array_batch, node_pairs_s_labels_array_batch, subpaths_s_array_batch_neis_2_order, subpaths_s_nodes_lens_array_batch, nodes_s_2_order, subpaths_q_array_batch, subpaths_lens_q_array_batch, node_pairs_q_valid_array_batch, node_pairs_q_labels_array_batch, subpaths_q_array_batch_neis_2_order, subpaths_q_nodes_lens_array_batch, nodes_q_2_order, \
			hub_subpaths_s_array_batch, hub_subpaths_lens_s_array_batch, hub_subpaths_s_valid_array_batch, hub_subpaths_s_nodes_array_batch_neis_2_order, hub_subpaths_s_nodes_lens_array_batch, hub_subpaths_q_array_batch, hub_subpaths_lens_q_array_batch, hub_subpaths_q_valid_array_batch, hub_subpaths_q_nodes_array_batch_neis_2_order, hub_subpaths_q_nodes_lens_array_batch
